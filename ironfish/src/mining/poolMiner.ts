 ...
 * file, You can obtain one at https://mozilla.org/MPL/2.0/. */
 ...
 import { givenHash } from './stratum/stratumServer' 
 import { Config } from '../fileStores'
 import sqlite3 from 'sqlite3'

 export let saveHashRate: number = 0

 export let sendHash: number = 0
 ...
 export class MiningPoolMiner {
  ...
  constructor(options: {
   ...
   async newWork(miningRequestId: number, header: Buffer) {
     ...
     givenHash.hash = sendHash += this.hashRate.rate1s
